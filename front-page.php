...
if (have_posts()) {
  while(have_posts()) {
    ...
    <div class="hero">
        ...
        <div class="hero__img" style="background-image:url(<?php echo esc_url(get_field('hero_img')['url']) ?>);">
    ...
    <section class="section-wrapper bg-line">
        ...
        <section class="section section-6" >
            ...
            if(have_rows('section_6')) :
                while(have_rows('section_6')) : the_row(); ?>
                    <div class="section-6__img" style="background-image:url(<?php echo esc_url(get_sub_field('section_6_img')['url']) ?>);">
    ...
    <div class="swiper section section-7 clearfix">
    ...
    <section class="section section-8">
        ...
        if(have_rows('section_8')) :
            ...
            <div class="section-8__container">
                <h3 class="section-8__container__title">
                    <?php echo get_sub_field('section_8_title');?>
                </h3>
                <p class="section-8__container__text">
                    <?php echo get_sub_field('section_8_text'); ?>
                </p>
                <button class="section-8__container__button">
                    <?php echo get_sub_field('section_8_btn'); ?>
                </button>
            </div>
            <div class="section-8__img">
                <img src="<?php echo esc_url(get_sub_field('section_8_img')['url']) ?>" alt="" class="section-8__img-img">
            </div>
        <?php 
            endwhile; 
        endif ?>
    ...
    <section class="section section-11">
        ...
        if(have_rows('section_11')) :
            ...
            <div class="section-11__img">
                <img src="<?php echo get_sub_field('section_11_img')['sizes']['medium']; ?>" alt="" class="section-11__img-img">
            </div>
